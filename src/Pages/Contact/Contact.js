        ...
        <div className='py-6 w-full'>
          <div className='grid max-w-6xl grid-cols-1 px-2 mx-auto lg:px-8 md:grid-cols-2 md:divide-x divide-primary'>
            ...
            <form className='flex flex-col py-6 space-y-6 md:py-0 md:px-6 ng-untouched ng-pristine ng-valid'>
              ...
              <button
                type='submit'
                className='self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 dark:bg-primary dark:text-gray-900 focus:ring-primary hover:ring-primary'
              >
                Submit
              </button>
            </form>
