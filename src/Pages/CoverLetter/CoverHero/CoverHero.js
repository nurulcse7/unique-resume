  ...
  return (
    <div>
      <section class="bg-gray-50">
        <div class=" container mx-auto  px-4 py-32 lg:flex  lg:items-center">
          <div class="mx-auto max-w-xl text-center">
            ...
            <div class="mt-8 flex flex-wrap justify-center gap-4">
              ...
              <a
                class="block w-full rounded px-12 py-3 text-sm font-medium  shadow  focus:outline-none focus:ring  sm:w-auto"
                href="/about"
              >
                Learn More
              </a>
