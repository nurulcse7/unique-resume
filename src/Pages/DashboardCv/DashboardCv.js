      ...
      {template ? (
            ...
            <div className="my-4">
              ...
              <div className="w-[60%] mx-auto mt-5">
                <p className="text-sm font-semibold">
                  There is a Curriculam Vita {"(CV)"} currently associated to
                  you. You can manage your CV from here.
                </p>
              </div>
            </div>
        ...
        <>
          <div className="my-4">
            ...
            <div className="w-[60%] mx-auto mt-5">
              <p className="text-sm font-semibold">
                There is no Curriculam Vita {"(CV)"} currently associated to
                you. When you create one it will show up here for you to manage.
              </p>
            </div>
