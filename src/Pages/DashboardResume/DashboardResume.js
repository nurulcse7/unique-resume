...
import { userResume } from "../../redux/action/data";
...
const DashboardResume = () => {
  ...
  // const { template } = data?.cvdata?.data;
                            ...
                            <div className="leading-none mt-2">
                              <div className="">
                                <small className="block">
                                  A person who is quietiy confident makes the
                                  best leader
                                </small>
                              ...
                              <div className="flex">
                                ...
                                <div>
                                  ...
                                  <small>
                                    ...
                                    adds more business value than anything else
                                    a leader does.
                                  </small>
                                </div>
                              </div>
                            ...
                            <div className="leading-none">
                              ...
                              <p className="ml-2 mt-2">
                                ...
                                <small className="pl-2">
                                  Secured high-profile strategic partnerships
                                  that lead to
                                </small>
                              </p>
                              <p className="ml-2 mt-2">
                                <span>•</span>
                                <small className="pl-2">
                                  Collaborated with product development teams
                                  and
                                </small>
                              </p>
                              <p className="ml-2 mt-2">
                          ...
                          <div>
                            ...
                            <div className="leading-none">
                              ...
                              <p className="ml-2 mt-2">
                                <span>•</span>
                                <small className="pl-2">
                                  Developed and executed a customer-focused
                                  growth plan,
                                </small>
                              </p>
                              <p className="ml-2 mt-2">
                                <span>•</span>
                                <small className="pl-2">
                                  Boosted sales performance by hiring 18 new
                                  sales
                                </small>
                              </p>
                            </div>
